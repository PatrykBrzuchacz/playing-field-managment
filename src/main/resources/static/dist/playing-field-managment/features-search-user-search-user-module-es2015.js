...
let SearchUserComponent = class SearchUserComponent {
    constructor(userService, router, geoLocationService, locationService, dialog, authService, friendsService, toastrService, messageService, domSanitizer, dataSharingService) {
        ...
        this.handleSelectedLocationChange = () => {
            return this.searchForm.controls.city.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["switchMap"])((address) => {
    ...
    sendMessage(user) {
        this.messageService.getMessages(user.id).subscribe(val => {
            this.dialog.open(_app_shared_components_message_dialog_message_dialog_component__WEBPACK_IMPORTED_MODULE_15__["MessageDialogComponent"], {
                width: "620px",
                data: {
                    messages: val,
                    id: user.id,
