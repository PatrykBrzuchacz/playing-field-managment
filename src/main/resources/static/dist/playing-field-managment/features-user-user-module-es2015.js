...
let EditUserDataComponent = class EditUserDataComponent {
    constructor(data, dialogRef, userService, toastrService, locationService, geolocationService) {
        ...
        this.handleSelectedLocationChange = () => {
            return this.userForm.controls.city.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["switchMap"])((address) => {
    ...
    editUser() {
        ...
        if (formData.position === "Bramkarz") {
            ...
            position = "";
        let editUserDto = new _app_shared_model__WEBPACK_IMPORTED_MODULE_5__["EditUserDto"](this.data.user.id, formData.age, formData.phoneNumber, this.newAvatar, position, formData.city, formData.firstName, formData.lastName, formData.email);
...
EditUserDataComponent.ctorParameters = () => [
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
...
let UserPanelComponent = class UserPanelComponent {
    ...
    editUser() {
        const dialogRef = this.dialog.open(_edit_user_data_edit_user_data_component__WEBPACK_IMPORTED_MODULE_9__["EditUserDataComponent"], {
            width: "60%",
    ...
    sendMessage(id, username) {
        this.messageService.getMessages(id).subscribe(val => {
            this.dialog.open(_app_shared_components_message_dialog_message_dialog_component__WEBPACK_IMPORTED_MODULE_16__["MessageDialogComponent"], {
                width: "620px",
                data: {
                    messages: val,
                    id: id,
    ...
    handleFriendsInviteTableChange() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_12__["merge"])(this.sort.sortChange, this.friendInvitePaginator.page, this.friendInvitePaginator.pageSize)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_24__["startWith"])({}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_24__["switchMap"])(() => {
            const params = {
                sort: ``,
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_24__["map"])((data) => {
            this.friendsInviteLength = data.totalElements;
            return data.content;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_24__["catchError"])(() => {
    ...
    checkMatch(match) {
        const dialogRef = this.dialog.open(_app_functionalities_playing_field_components_teams_dialog_teams_dialog_component__WEBPACK_IMPORTED_MODULE_14__["TeamsDialogComponent"], {
            width: "800px",
            data: {
