...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-search-match-search-match-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFunctionalitiesSearchMatchSearchMatchSearchMatchComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFunctionalitiesSearchMatchSearchMatchRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SearchMatchRoutingModule", function () {
    ...
    var _search_match_search_match_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./search-match/search-match.component */
    ...
    var SearchMatchRoutingModule = function SearchMatchRoutingModule() {
      _classCallCheck(this, SearchMatchRoutingModule);
    };

    SearchMatchRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppFunctionalitiesSearchMatchSearchMatchModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SearchMatchModule", function () {
    ...
    var _search_match_search_match_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./search-match/search-match.component */
    "./src/app/functionalities/search-match/search-match/search-match.component.ts");
    /* harmony import */


    var _search_match_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./search-match-routing.module */
    "./src/app/functionalities/search-match/search-match-routing.module.ts");
    /* harmony import */
    ...
    var _app_shared_service_google_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @app/shared/service/google.service */
    "./src/app/shared/service/google.service.ts");

    var SearchMatchModule = function SearchMatchModule() {
      _classCallCheck(this, SearchMatchModule);
    };

    SearchMatchModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_search_match_search_match_component__WEBPACK_IMPORTED_MODULE_2__["SearchMatchComponent"]],
      imports: [_search_match_routing_module__WEBPACK_IMPORTED_MODULE_3__["SearchMatchRoutingModule"], _app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _agm_core__WEBPACK_IMPORTED_MODULE_5__["AgmCoreModule"].forRoot({
        apiKey: 'AIzaSyC7Iy1oeCLfim7-B5c_Aro6pTr_oFifBGM'
      })],
      providers: [_agm_core__WEBPACK_IMPORTED_MODULE_5__["GoogleMapsAPIWrapper"], _app_shared_service_geo_location_service__WEBPACK_IMPORTED_MODULE_6__["GeoLocationService"], _app_shared_service_google_service__WEBPACK_IMPORTED_MODULE_7__["GoogleService"]]
    })], SearchMatchModule);
    /***/
  },
  ...
  /***/
  function srcAppFunctionalitiesSearchMatchSearchMatchSearchMatchComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFunctionalitiesSearchMatchSearchMatchSearchMatchComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SearchMatchComponent", function () {
    ...
    var _app_shared_service_location_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _app_shared_model_playing_field__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    var _app_shared_service_user_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! @app/shared/service/user.service */
    "./src/app/shared/service/user.service.ts");
    /* harmony import */


    var _app_core_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @app/core/service */
    "./src/app/core/service/index.ts");
    /* harmony import */


    var _app_functionalities_playing_field_components_teams_dialog_teams_dialog_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    ...
    var _app_shared_service_team_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! @app/shared/service/team.service */
    "./src/app/shared/service/team.service.ts");
    /* harmony import */


    var _app_functionalities_playing_field_components_reservation_dialog_reservation_dialog_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    ...
    function () {
      function SearchMatchComponent(locationService, geoLocationService, mapsApiLoader, matchService, userService, dialog, authService, teamService, dataSharingService, toastrService, router) {
        ...
        _classCallCheck(this, SearchMatchComponent);
        ...
        this.displayedColumns = ["name", "address", "matchFrom", "matchTo", "private", "reserved", "size", "rate", "options"];
      ...
      _createClass(SearchMatchComponent, [{
        key: "ngOnInit",
        ...
        value: function initForm() {
          ...
          if (searchParams) {
            if (searchParams.searchDto.fromDate < moment__WEBPACK_IMPORTED_MODULE_11__(new Date()).format("YYYY-MM-DD")) {
        ...
        value: function getUserLocation() {
          ...
          if (navigator) {
            navigator.geolocation.getCurrentPosition(function (pos) {
              _this2.userLocation.lng = pos.coords.longitude;
              _this2.userLocation.lat = pos.coords.latitude;

              _this2.handlePFTableChange();
            });
          }
        }
      }, {
        ...
        key: "setMyLocalization",
        value: function setMyLocalization() {
          ...
          if (!match.isBanned) {
            ...
            dialogRef.afterClosed().subscribe(function (val) {
              if (val) {
                ...
                match.isBooked = true;
                match.size = 1;
                match.ownerUsername = _this4.loggedUser.username;
                match.ownerId = _this4.loggedUser.username;
        ...
        value: function handlePFTableChange() {
          ...
          if (searchParams) {
            ...
            this.loading = true;
            Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(this.sort.sortChange, this.matchPaginator.page, this.matchPaginator.pageSize).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["startWith"])({}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function () {
              var params = {
                sort: ["matchFromDate,asc", "matchFromTime,asc"],
                page: _this5.matchPaginator.pageIndex + "",
                size: _this5.matchPaginator.pageSize + ""
              };
              return _this5.matchService.getMatchesByLocation(searchParams, params);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (data) {
              _this5.matchLength = data.totalElements;
              return data.content;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["catchError"])(function () {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])([]);
            })).subscribe(function (data) {
              _this5.matchesWithLocationDto = data;
    ...
    SearchMatchComponent.ctorParameters = function () {
      return [{
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTable"], {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTable"])], SearchMatchComponent.prototype, "matchWithLocationDtoTable", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_20__["MatPaginator"], {
      static: true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_20__["MatPaginator"])], SearchMatchComponent.prototype, "matchPaginator", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_20__["MatSort"], {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_20__["MatSort"])], SearchMatchComponent.prototype, "sort", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_agm_core__WEBPACK_IMPORTED_MODULE_10__["AgmMap"], {
      static: true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _agm_core__WEBPACK_IMPORTED_MODULE_10__["AgmMap"])], SearchMatchComponent.prototype, "map", void 0);
    SearchMatchComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-search-match",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./search-match.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/functionalities/search-match/search-match/search-match.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./search-match.component.scss */
      "./src/app/functionalities/search-match/search-match/search-match.component.scss")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_shared_service_location_service__WEBPACK_IMPORTED_MODULE_6__["LocationService"], _app_shared_service_geo_location_service__WEBPACK_IMPORTED_MODULE_9__["GeoLocationService"], _agm_core__WEBPACK_IMPORTED_MODULE_10__["MapsAPILoader"], _app_shared_service_match_service__WEBPACK_IMPORTED_MODULE_13__["MatchService"], _app_shared_service_user_service__WEBPACK_IMPORTED_MODULE_15__["UserService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"], _app_core_service__WEBPACK_IMPORTED_MODULE_16__["AuthService"], _app_shared_service_team_service__WEBPACK_IMPORTED_MODULE_18__["TeamService"], _app_shared_service_data_sharing_service__WEBPACK_IMPORTED_MODULE_14__["DataSharingService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_21__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_22__["Router"]])], SearchMatchComponent);
    /***/
  }
}]);
//# sourceMappingURL=features-search-match-search-match-module-es5.js.map