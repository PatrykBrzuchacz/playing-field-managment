...
let SearchMatchComponent = class SearchMatchComponent {
    constructor(locationService, geoLocationService, mapsApiLoader, matchService, userService, dialog, authService, teamService, dataSharingService, toastrService, router) {
        ...
        this.handleSelectedLocationChange = () => {
            return this.searchForm.controls.city.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])((address) => {
                return this.geoLocationService.getPositions(address);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])((data) => {
                return data && data;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["catchError"])((error) => {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])([]);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])((data) => {
    ...
    initForm() {
        ...
        if (searchParams) {
            ...
            const defaultToDate = moment__WEBPACK_IMPORTED_MODULE_11__(new Date(), "YYYY-MM-DD").add(5, "days");
            this.searchForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    checkMatch(match) {
        const dialogRef = this.dialog.open(_app_functionalities_playing_field_components_teams_dialog_teams_dialog_component__WEBPACK_IMPORTED_MODULE_17__["TeamsDialogComponent"], {
            width: "800px",
            data: {
    ...
    makeReserveation(match) {
        if (!match.isBanned) {
            const dialogRef = this.dialog.open(_app_functionalities_playing_field_components_reservation_dialog_reservation_dialog_component__WEBPACK_IMPORTED_MODULE_19__["ReservationDialogComponent"], {
                width: "400px",
    ...
    handlePFTableChange() {
        ...
        if (searchParams) {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(this.sort.sortChange, this.matchPaginator.page, this.matchPaginator.pageSize)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["startWith"])({}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(() => {
                const params = {
                ...
                .subscribe(data => {
                this.matchesWithLocationDto = data;
                this.loading = false;
            });
        }
    }
...
SearchMatchComponent.ctorParameters = () => [
