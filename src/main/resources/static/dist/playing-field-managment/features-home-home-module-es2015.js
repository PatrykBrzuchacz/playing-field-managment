...
AssignPlayingFieldAndRegisterDialogComponent.ctorParameters = () => [
...
let MainPageComponent = class MainPageComponent {
    constructor(googleService, geoLocationService, authService, toastr, mapsApiLoader, locationService, userService, dialog) {
        ...
        this.handleSelectedLocationChange = () => {
            return this.selectedLocationControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["switchMap"])((address) => {
                return this.geoLocationService.getPositions(address);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])((data) => {
                return data && data;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["catchError"])((error) => {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])([]);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])((data) => {
