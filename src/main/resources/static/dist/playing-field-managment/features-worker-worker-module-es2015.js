...
WorkerAddCodeDialogComponent.ctorParameters = () => [
...
WorkerPFDatePickerComponent.ctorParameters = () => [
...
let WorkerPFMenuComponent = class WorkerPFMenuComponent {
    ...
    openSetPFAvailabilityDialog() {
        const dialogRef = this.dialog.open(_worker_pfdate_picker_worker_pfdate_picker_component__WEBPACK_IMPORTED_MODULE_4__["WorkerPFDatePickerComponent"], {
            width: "400px",
            data: this.pfId
        });
    ...
    setPFSetup() {
        const dialogRef = this.dialog.open(_worker_pfsetup_dialog_worker_pfsetup_dialog_component__WEBPACK_IMPORTED_MODULE_8__["WorkerPFSetupDialogComponent"], {
            width: "400px",
            data: {
    ...
    banUser(userId) {
        const dialogRef = this.dialog.open(_app_shared_components_worker_ban_dialog_worker_ban_dialog_component__WEBPACK_IMPORTED_MODULE_16__["WorkerBanDialogComponent"], {
            width: "30%",
...
WorkerPFMenuComponent.ctorParameters = () => [
...
let WorkerPFSetupDialogComponent = class WorkerPFSetupDialogComponent {
    ...
    setPFSetup() {
        ...
        const pfSetup = new _app_shared_model_playing_field__WEBPACK_IMPORTED_MODULE_4__["PlayingFieldSetupDto"](this.pfSetupForm.value.description, this.pfSetupForm.value.teamSize, this.pfPhoto, this.pfSetupForm.value.name);
...
WorkerPFSetupDialogComponent.ctorParameters = () => [
...
class PFAvailabilityDto {
    constructor(openDatePF, closeDatePF, openTimePF, closeTimePF, matchTime) {
